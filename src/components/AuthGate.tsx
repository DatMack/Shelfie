...
function WelcomeScreen({ onAuthenticated }: { onAuthenticated: (session: Session) => void }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(submitError instanceof Error ? submitError.message : 'Shelfie could not complete that request.')
    } finally {
      setSubmitting(false)
    }
  }
    ...
    <main className="welcome-page">
      <section className="welcome-story" aria-label="About Shelfie">
        ...
        <div className="welcome-copy">
          ...
          <p>
            Track what you read, collect the editions you love, build streaks, complete quests,
            unlock rewards, and turn your bookshelf into something that feels like yours.
          </p>
        </div>

        <div className="welcome-bookcase" aria-hidden="true">
          <div className="welcome-shelf-books">
            <span className="welcome-book b1">READ</span>
            <span className="welcome-book b2">EXPLORE</span>
            <span className="welcome-book b3">COLLECT</span>
            <span className="welcome-book b4">LEVEL UP</span>
            <span className="welcome-book b5">REPEAT</span>
          </div>
      ...
      <section className="welcome-auth-wrap">
        <div className="welcome-auth-card">
          ...
          <div className="auth-heading">
            ...
            <p>
              {mode === 'signin'
                ? 'Sign in to open your bookshelf.'
                : 'A username, email, and password are all you need to get started.'}
            </p>
          </div>

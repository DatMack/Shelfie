export type ReadingStatus = 'Currently Reading' | 'To Be Read' | 'Read' | 'Want to Read' | 'DNF'
...
export const sampleBooks: Book[] = [
  ...
  { id: '9', title: 'The Atlas Six', author: 'Olivie Blake', status: 'To Be Read', shelfIndex: 2, color: '#544c34', accent: '#d3b86a', pages: 384, genre: 'Fantasy', subjects: ['Fantasy', 'Dark Academia'], year: 2020, source: 'sample', owned: true, format: 'Paperback', condition: 'New', purchasePrice: 13.99, estimatedValue: 12 },
  { id: '10', title: 'A Court of Thorns and Roses', author: 'Sarah J. Maas', status: 'To Be Read', shelfIndex: 2, color: '#6c342f', accent: '#e6b96d', pages: 448, genre: 'Fantasy Romance', subjects: ['Fantasy', 'Romance', 'Fae'], year: 2015, source: 'sample', owned: true, format: 'Paperback', condition: 'Good', purchasePrice: 11.99, estimatedValue: 8 },
  ...
  { id: '12', title: 'The Lion Women of Tehran', author: 'Marjan Kamali', status: 'To Be Read', shelfIndex: 2, color: '#a05a2e', accent: '#f1c77c', pages: 336, genre: 'Historical Fiction', subjects: ['Historical Fiction', 'Iran'], year: 2024, source: 'sample', owned: true, format: 'Hardcover', condition: 'Like New', purchasePrice: 20, estimatedValue: 17 },
]
